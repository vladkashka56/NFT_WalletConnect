...
contract GamebopItem is ERC721URIStorage {
    ...
    constructor(address _marketplaceAddress) ERC721("GamebopItem", "GI") {
        marketplaceAddress = _marketplaceAddress;
    }

    function mintToken(string memory tokenURI, uint256 royalty) public returns (uint256) {
        _tokenIds.increment();
    ...
    function getTokenRoyaltyById(uint256 tokenId) public view returns (uint256) {
    ...
    function setApproval(address _updateMarketplace) public onlyOwner {
        marketplaceAddress = _updateMarketplace;
        setApprovalForAll(marketplaceAddress, true);
    }
}